...
class DNASegment:
    def __init__(self):
        ...
        self.min_prob = 0 #最小的概率

    #估算未出现的词的概率,根据beautiful data里面的方法估算
    def get_unkonw_word_prob(self, word):
        #print "unknow word prob ", word,self.min_prob-math.log(len(word))
        return self.min_prob-math.log(10**len(word))
    ...
    def initial_dict(self,filename):
        ...
        self.min_prob = min(self.word_dict[key] for key in self.word_dict.iterkeys())
        print "min prob",self.min_prob
#test
